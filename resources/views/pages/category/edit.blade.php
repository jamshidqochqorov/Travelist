            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('categoryIndex') }}">Katgroya</a></li>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('categoryUpdate',$category->id) }}" method="post">
                            ...
                            <div class="form-group">
                                <label>Narxi</label>
                                <input type="number" name="price" class="form-control {{ $errors->has('price') ? "is-invalid":"" }}" value="{{ old('price',$category->price) }}" >
                                @if($errors->has('price'))
